...
class ModuleEventReader extends EventsExt
{
    ...
    public function generate()
    {
        ...
        if (!isset($_GET['events']) && isset($_GET['auto_item'])) {
        ...
        $cals = ($this->cal_holiday)
            ? array_merge(\Contao\StringUtil::deserialize($this->cal_calendar), \Contao\StringUtil::deserialize($this->cal_holiday))
    ...
    protected function compile()
    {
        ...
        if ($objEvent->teaser != '') {
            $objPage->description = $objEvent->teaser;
